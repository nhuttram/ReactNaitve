...
export type IconProps = Omit<RNVectorIconProps, "name" | "size"> & {
  name: MaterialCommunityIconsGlyphs;
  size?: "small" | "medium" | "large" | "xlarge" | "xxlarge" | number;
};

const Icon = ({ size = "medium", ...otherProps }: IconProps): ReactElement => {
  ...
  return <MaterialCommunityIcons size={iconSize} {...otherProps} />;
};
