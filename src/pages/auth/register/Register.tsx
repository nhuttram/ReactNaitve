    ...
    <View style={styles.container}>
      <ImageBackground source={BG} resizeMode="cover" style={styles.bg}>
        ...
        <Text
          style={[
            styles.text,
            {fontSize: 26, lineHeight: 60, marginBottom: 10},
          ]}>
          {' '}
          Sign Up For Free
        </Text>
        ...
        <View style={styles.formInput}>
          <View style={styles.formInputLayout}>
            <Icon
              style={[styles.icon, {color: '#15BE77'}]}
              name="account"
              size={25}
            />
          ...
          <View style={styles.formInputLayout}>
            ...
            <TextInput
              ...
              secureTextEntry={checkShowPassword ? true : false}
            />
            {!checkShowPassword ? (
              <Icon
                onPress={handlerShowOnPassword}
                style={[styles.iconEeye]}
                name="eye-outline"
                size={25}
              />
            ) : (
              <Icon
                onPress={handlerShowOffPassword}
                style={[styles.iconEeye]}
                name="eye-off"
                size={25}
              />
